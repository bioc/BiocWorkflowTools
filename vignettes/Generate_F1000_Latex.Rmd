...
While you are writing your Rmarkdown document (and indeed once it is complete), you probably want to view the journal formatted PDF version or obtain a LaTeX source for submission to the journal.

If you're working in RStudio you can simply press the 'Knit' button at the top of the document pane.  This will execute the code chunks, convert the document to LaTeX and then compile this into a PDF.  You will be able to find both the **.tex** and **.pdf** files in the same folder as the original **.Rmd**.
