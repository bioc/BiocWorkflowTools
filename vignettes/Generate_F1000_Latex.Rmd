...
Funding for continued development and maintenance of this package is currently provided by the German Network for Bioinformatics Infrastructure (de.NBI).

```{r, include_logo, out.width="50%", echo=FALSE}
